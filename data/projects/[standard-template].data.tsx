...
const features: Feature[] = [
    {//Feature 1
        ...
        feature_type: 'Backend', // Available values ['Backend', 'Fullstack', 'Architecture', 'DevOps', 'Frontend']
    },
    {//Feature 2
        icon: PaintbrushIcon,
        name: '{{FEATURE_2_NAME}}',
...
const technicalChallenges: TechnicalChallengeData[] = [
    {
        ...
        scopePresentation: "{{Petit paragraphe pour presenter le scope.}}",
    ...
    },
    {
        ...
        scopePresentation: "{{CHALLENGE_SCOPE_2_DESC}}",
        icon: ArrowPathIcon,
        challengesList: [
            "{{CHALLENGE_2_ITEM_1}}",
            "{{CHALLENGE_2_ITEM_2}}",
...
export const standardProjectTemplateData: StandardProjectData = {
