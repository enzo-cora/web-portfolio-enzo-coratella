...
const ProfileSection = () => {
	return (
		<div className="w-full py-8 md:py-0 bg-white dark:bg-gray-900 px-6">
			<div className="space-y-8 text-center">
				...
				<div className="space-y-6 px-4">
					...
					<a
						...
						className="w-full inline-block px-4 py-2 text-white font-semibold bg-gray-700 rounded-md hover:bg-gray-800 transition-colors dark:bg-gray-600 dark:hover:bg-gray-700"
					>
						Download Resume
					</a>
				</div>
